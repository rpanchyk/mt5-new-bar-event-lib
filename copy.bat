...
copy /y "%DATA_DIR%\%INCLUDE_DIR%\NewBarEvent.mqh" "%INCLUDE_DIR%"
copy /y "%DATA_DIR%\%EXPERTS_DIR%\NBETestEA.mq5" "%EXPERTS_DIR%"
::copy /y "%DATA_DIR%\%INDICATORS_DIR%\My_IND.mq5" "%INDICATORS_DIR%"
